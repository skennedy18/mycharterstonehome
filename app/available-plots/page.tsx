			...
			<div className='pt-20'>
				<section className='bg-gradient-to-r from-burgundy to-navy text-white py-16'>
					<div className='container mx-auto px-4'>
						...
						<p className='text-xl text-white/90 max-w-2xl'>Choose your perfect homesite at Pecan Villas. Each plot offers unique features and stunning views.</p>
					</div>
				</section>
						...
						<Card className='bg-gradient-to-r from-burgundy to-navy text-white'>
							<CardContent className='p-8 md:p-12'>
								<div className='max-w-3xl mx-auto text-center'>
									...
									<p className='text-xl text-white/90 mb-8'>Our team is here to help you select the perfect homesite and answer any questions about available homesites.</p>
