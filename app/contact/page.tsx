                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            <span
                              className={`inline-flex items-center gap-2 text-xs font-medium ${isOpen() ? "text-green-600" : "text-red-600"}`}
                            >
                  ...
                  <CardContent className="p-8">
                    ...
                    {isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="model">Specific Home Model</SelectItem>
                              <SelectItem value="custom">Custom Home Design</SelectItem>
                        ...
                        <Button type="submit" size="lg" className="w-full bg-burgundy hover:bg-burgundy/90 text-white">
                          Send Message
                        </Button>
                      </form>
                    )}
